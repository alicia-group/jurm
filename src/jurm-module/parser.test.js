...
it('should parser clear statement', () => {
  ...
  let clear_statement_expected = new Statement(tokens.ZERO, [tokens.REGISTER_NUMBER, 0], 1);
...
it('should parser successor statement', () => {
  ...
  let statement_expected = new Statement(tokens.SUC, [tokens.REGISTER_NUMBER, 1], 1);
...
it('should parser successor and zero statement', () => {
  ...
  let suc_statement_expected = new Statement(tokens.SUC, [tokens.REGISTER_NUMBER, 1], 2);
  let zero_statement_expected = new Statement(tokens.ZERO, [tokens.REGISTER_NUMBER, 10], 3);
...
it('should parser load number in register statement', () => {
  ...
  let ld_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 5, tokens.NATURAL_NUMBER, 10], 1);
...
it('should parser load register in another register statement', () => {
  ...
  let ld_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 5, tokens.REGISTER_NUMBER, 10], 1);
  expect(result.statements).toStrictEqual([ld_statement_expected]);
  expect(result.line_with_parser_error).toStrictEqual(-1);
});
...
it('should parser jump statement', () => {
  ...
  let jp_statement_expected = new Statement(tokens.JUMP, [tokens.REGISTER_NUMBER, 1, tokens.REGISTER_NUMBER, 10, tokens.NATURAL_NUMBER, 100], 1);
...
it('should parser clear statement and load statement with extra new lines', () => {
  ...
  let clear_statement_expected = new Statement(tokens.ZERO, [tokens.REGISTER_NUMBER, 0], 1);
  let load_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 0, tokens.NATURAL_NUMBER, 10], 4);
  expect(result.statements).toStrictEqual([clear_statement_expected, load_statement_expected]);
  expect(result.line_with_parser_error).toStrictEqual(-1);
});
...
it('should parser clear statement and two load statement with extra new lines', () => {
  ...
  let clear_statement_expected = new Statement(tokens.ZERO, [tokens.REGISTER_NUMBER, 0], 1);
  let first_load_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 0, tokens.NATURAL_NUMBER, 10], 4);
  let second_load_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 0, tokens.NATURAL_NUMBER, 10], 6);
...
it('should fail on third wrong statement before two load statement', () => {
  ...
  let first_load_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 0, tokens.NATURAL_NUMBER, 10], 1);
  let second_load_statement_expected = new Statement(tokens.COPY, [tokens.REGISTER_NUMBER, 0, tokens.NATURAL_NUMBER, 10], 2);
...
it('should fail on wrong statement after new lines', () => {
  ...
  expect(result.line_with_parser_error).toStrictEqual(4);
});
